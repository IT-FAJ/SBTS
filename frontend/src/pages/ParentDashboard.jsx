                ...
                >
                    <div className="bg-white border border-primary-200 rounded-2xl p-4 flex items-center justify-between gap-4 shadow-[0_10px_40px_rgba(0,0,0,0.08)] relative overflow-hidden">
                        ...
                        <div className="flex items-center gap-4 z-10">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-800 text-sm">{t('parent.notification')}</h4>
                                <p className="text-gray-500 text-xs mt-0.5 leading-relaxed">
                                    {t('parent.notificationMsg')}
                                </p>
                            </div>
                        </div>
                        <button
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="relative z-10">
                                <h3 className="font-bold text-xl text-gray-800 mb-1">{t('parent.eta')}</h3>
                                <p className="text-gray-500 text-sm">{t('parent.etaLabel')} <span className="font-bold text-gray-700">النخيل</span></p>
                            </div>
                        </div>
